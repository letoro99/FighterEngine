...
int main()
{
    ...
    // FragmentShader -> focus on the color for each pixel of a draw
    ...
    //ShaderProgram -> Links vertexShader and fragmentShader
    unsigned int ID = glCreateProgram(); // se identifica el id del shader con la variable de la clase
